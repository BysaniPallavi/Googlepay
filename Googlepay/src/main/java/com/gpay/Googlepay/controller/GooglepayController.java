...
//import com.gpay.Googlepay.Dto.GooglePayCustomerDetailsDto;
...
public class GooglepayController {
   ...
   @GetMapping("/{googlepayId}")
	public Googlepay getGooglepayById(@PathVariable Long Id) throws AccountNotFoundException {
		return  googlepayService.getGooglepayById(Id);
   }
